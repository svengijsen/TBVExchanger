...
BrainStim.addOutputWindow("RealTimeFeedback");
BrainStim.clearOutputWindow("RealTimeFeedback");
//Configuration
...
{	
	...
	if(currentState == ExperimentManager.ExperimentState.ExperimentManager_Initialized)
	{
		...
		{
			BrainStim.write2OutputWindow(".*. Something went wrong connecting the Signal/Slots:" + e, "RealTimeFeedback");
		}			
	}	
	...
	{	
		...
		{
			BrainStim.write2OutputWindow(".*. Something went wrong disconnecting the Signal/Slots:" + e, "RealTimeFeedback");
		}			
	}		
