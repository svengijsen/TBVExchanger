...
BrainStim.addOutputWindow("TBVExchanger");
BrainStim.clearOutputWindow("TBVExchanger");
//Configuration
(function( RealTimeFeedback, undefined )
{ 
//Public Property Variabeles
	if (typeof TBVExchanger !== 'undefined')
		RealTimeFeedback.TBVExchangerObject = new TBVExchanger();//Construct a new Plugin object
	else
		BrainStim.write2OutputWindow("***ERROR***: The script plugin class named 'TBVExchanger' is not available, probably due to a missing plugin?", "TBVExchanger");
	
//Public Property Functions
	RealTimeFeedback.__proto__.executePreStep = function(nTimePoint)
	{
		BasicExperiment.LogFunctionSignature("TBVExchanger","executePreStep", arguments, false);
	}

	RealTimeFeedback.__proto__.executePostStep = function(nTimePoint)
	{
		BasicExperiment.LogFunctionSignature("TBVExchanger","executePostStep", arguments, false);
	}
	
	RealTimeFeedback.__proto__.executePostRun = function(nTimePoint)
	{
		BasicExperiment.LogFunctionSignature("TBVExchanger","executePostRun", arguments, false);	
	}

	RealTimeFeedback.__proto__.disconnected = function()
	{
		BasicExperiment.LogFunctionSignature("TBVExchanger","disconnected", arguments, false);	
	}

	RealTimeFeedback.__proto__.connected = function()
	{
		BasicExperiment.LogFunctionSignature("TBVExchanger","connected", arguments, false);
	}

	RealTimeFeedback.__proto__.connectionError = function(sError)
	{
		BasicExperiment.LogFunctionSignature("TBVExchanger","connectionError", arguments, false);
	}
...
{	
	...
	BasicExperiment.LogFunctionSignature("TBVExchanger","preExperimentStateChanged", args, true);
	if(currentState == ExperimentManager.ExperimentState.ExperimentManager_Initialized)
	{
		...
		{
			BrainStim.write2OutputWindow(".*. Something went wrong connecting the Signal/Slots:" + e, "TBVExchanger");
		}			
	}	
	...
	{	
		...
		{
			BrainStim.write2OutputWindow(".*. Something went wrong disconnecting the Signal/Slots:" + e, "TBVExchanger");
		}			
	}		
...
{	
	...
	BasicExperiment.LogFunctionSignature("TBVExchanger","checkRequiredScriptPlugins", args, true);
	if (typeof TBVExchanger === 'undefined')
	{
		BrainStim.write2OutputWindow("***ERROR***: The script plugin class named 'TBVExchanger' is not available, probably due to a missing plugin?", "TBVExchanger");
		return false;
