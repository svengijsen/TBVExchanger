...
/*!
The TBVExchanger can communicate with the Turbo-BrainVoyager software (3.2) from Brain Innovation (see http://www.brainvoyager.com/downloads/install_turbobrainvoyager.html).
*/
...
public:
	...
	static QScriptValue ctor_TBVExchanger(QScriptContext* context, QScriptEngine* engine);
...
*/
//@{
	//! \brief tGetCurrentTimePoint slot. 
	/*!
	...
	*/
	...
	//! \brief tGetExpectedNrOfTimePoints slot. 
	/*!
	...
	*/
	...
	//! \brief tGetDimsOfFunctionalData slot. 
	/*!
...
/** @name Protocol, DM, GLM Functions
	@anchor ProtocolDMGLMFunctions
*/
//@{
...
//@{
	...
	*/
	QList<float> tGetExistingMeansOfROI(int roi, int toTimePoint);
...
/** @name Volume Data Access Functions
@anchor VolumeDataAccessFunctions
*/
//@{
...
/** @name SVM Access Functions
	@anchor SVMAccessFunctions
*/
//@{
...
/** @name Functional Connectivity Functions
	@anchor FunctionalConnectivityFunctions
*/
//@{
